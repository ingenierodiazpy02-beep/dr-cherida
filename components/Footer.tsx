    ...
    <footer className="py-12 bg-charcoal relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center">
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }} className="font-sans text-xs tracking-[0.2em] uppercase text-cream/60 mb-8">
            {"Cirujana Dermat\u00f3loga \u2022 Rejuvenecimiento Facial"}
          </motion.p>
          <div className="w-24 h-px bg-gold/30 mb-8" />
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.3 }} className="font-sans text-xs text-cream/40">
