...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div initial={{ opacity: 0, x: 10 }} whileHover={{ opacity: 1, x: 0 }} className="absolute right-20 top-1/2 -translate-y-1/2 bg-charcoal text-cream px-4 py-2 rounded-sm whitespace-nowrap font-sans text-sm shadow-elegant pointer-events-none">
