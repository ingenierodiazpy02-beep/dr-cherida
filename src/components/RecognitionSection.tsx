        ...
        <section className="relative py-16 sm:py-24 md:py-32 bg-background overflow-hidden font-sans">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
                <motion.p
                    ...
                    className="text-xs md:text-sm tracking-[0.4em] uppercase text-muted-foreground mb-6"
                >
                    Reconocida Por
                </motion.p>
                ...
                <motion.p
                    ...
                    className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-xl mx-auto mb-12 font-light"
                >
                ...
                <motion.button
                    ...
                    className="text-xs tracking-[0.3em] uppercase border border-foreground/30 px-8 sm:px-10 py-3 sm:py-4 hover:bg-foreground hover:text-primary-foreground transition-all duration-500"
                >
                    Agendar Consulta
                </motion.button>
            </div>
